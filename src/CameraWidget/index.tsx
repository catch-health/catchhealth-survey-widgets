...
type SurveyType = {
	...
	CustomWidgetCollection: typeof CustomWidgetCollection;
	SvgRegistry: typeof SvgRegistry;
};
...
export function registerCameraWidget(
	...
	const cameraWidget = {
		...
		init: () => {
			...
			const readOnly = Survey.Serializer.findProperty("camera", "readOnly");
...
export function disableFileDataAsText(Survey: SurveyType) {
	const storeDataAsText = Survey.Serializer.findProperty(
		"file",
		"storeDataAsText"
	);
